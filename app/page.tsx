  ...
  return (
    <main className="shell">
      ...
      <section className="hero">
        ...
        {captured && <div className="preview" role="status"><div className="preview-icon"><BellRing size={18}/></div><div><b>Stored as a {mode === 'signal' ? 'context signal' : 'pattern trigger'}.</b><p>“{sample}”</p><small>Saved only in this browser. Nothing was sent to a server.</small></div></div>}
      </section>
      ...
      <footer><span>AFTERIMAGE / concept build 0.3</span><span>Memory → Context → Relevance → Resurface</span></footer>
    </main>
  );
}
